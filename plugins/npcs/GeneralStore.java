...
TalkToNpcExecutiveListener, TalkToNpcListener {
	...
	private final Shop baseShop = new Shop(true, 12400, 130, 40, 3, new Item(
			77, 5), new Item(78, 5), new Item(79, 5), new Item(80,
					5), new Item(76, 5), new Item(11, 3000), new Item(168, 5),
					new Item(1263, 10), new Item(112, 5), new Item(400, 5), 
					new Item(401, 5), new Item(402, 5), new Item(406, 5), new Item(407, 5),
					new Item(404, 5), new Item(316, 5), new Item(317, 5), new Item(81, 5));
