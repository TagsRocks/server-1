	...
	public void onCommand(String command, String[] args, Player player) {
		...
		if (command.equals("setevent")) {
			...
			for (Player p : World.getWorld().getPlayers()) {
				ActionSender.sendMessage(p, player, 1, MessageType.GLOBAL_CHAT, ("Event has been set at an interesting place"), player.getIcon());
			}
		}
		if (command.equals("questreset")) {
			...
			if (scrn != null && args.length == 3) {
				...
				player.message("::questreset <playername>, <questid>, <stage>");
			}
		} 
